import member01 from "../assets/images/member01.jpg"

function Testimonials() {
  return (
    <div>

<section className="pb-20 pt-20 lg:pb-[120px] lg:pt-[120px] dark:bg-dark">
                  ...
                  <div className="w-full md:flex">
                    ...
                    <div className="w-full">
                      <div>
                        ...
                        <p
                          className="mb-11 text-base font-normal italic leading-[1.81] text-body-color sm:text-[22px] dark:text-dark-6"
                        >
