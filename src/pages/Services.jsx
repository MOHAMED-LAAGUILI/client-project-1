    ...
    <div className="-mx-4 flex flex-wrap items-center justify-between">
        ...
        <div className="-mx-3 flex items-center sm:-mx-4">
          <div className="w-full px-3 sm:px-4 xl:w-1/2">
            <div className="py-3 sm:py-4">
              <img src="https://insights.ieseg.fr/wp-content/uploads/2021/06/iStock-1128319499.jpg-1200px.jpg" alt className="w-full rounded-2xl" />
            </div>
            <div className="py-3 sm:py-4">
              <img src="https://www.payscale.com/wp-content/uploads/2023/05/team-leader-scaled.jpg" alt className="w-full rounded-2xl" />
            </div>
          </div>
          <div className="w-full px-3 sm:px-4 xl:w-1/2">
            <div className="relative z-10 my-4">
              <img src="https://review.jobs/blog/wp-content/uploads/2023/12/le-leadership-dinfluence-730x325.jpg" alt className="w-full rounded-2xl" />
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div className="mt-10 lg:mt-0">
          ...
          <a href="javascript:void(0)" className="inline-flex items-center justify-center rounded-md border border-transparent bg-primary px-7 py-3 text-center text-base font-medium text-white hover:bg-opacity-90">
            Get Started
          </a>
        </div>
      </div>
