      ...
      <section className="bg-white dark:bg-dark">
        <div className="container mx-auto text-center">
          <p className="mb-8 text-lg text-body-color dark:text-white">
            Les entreprises qui font confiance à Archivom ont réalisé à quel
            point il est stratégique de s’appuyer sur un partenaire efficace qui
            leur permet de se concentrer sur leur cœur de métier, tout en
            apportant productivité et gains financiers.
          </p>
          <div className="flex flex-wrap justify-center gap-8">
            <a
              href="#"
              className="flex w-[600px] items-center justify-center py-5 2xl:w-[600px]"
            >
              <img
